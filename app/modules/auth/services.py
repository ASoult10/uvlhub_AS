...
class AuthenticationService(BaseService):
    ...
    def create_guest_user(self):
        try:
            ...
            # Si 'uuid' te da error aquí, es que falta el import arriba del todo
            ...
            if guest_role:
                ...
                # Si no existe el rol, imprimimos aviso pero permitimos crear el usuario
